...
class TestLeetrovacki(unittest.TestCase):
    ...
    def test_explicit_utro_mode_from_plain(self) -> None:
        encoder = Leetrovacki(base_mode="utro")
    ...
    def test_all_satro_module_examples_in_satro_mode(self) -> None:
        ...
        self.assertEqual(
            Leetrovacki(base_mode="satro", min_word_length=5).encode("riba rep"),
            "riba rep",
        )

    def test_utro_styles(self) -> None:
        encoder = Leetrovacki(base_mode="utro", za_style="z4", nje_style="nj3")
    ...
    def test_all_utro_module_examples_in_utro_mode(self) -> None:
        ...
        with_exceptions = Leetrovacki(base_mode="utro", exceptions={"brate": "tebra"})
        self.assertEqual(with_exceptions.encode("brate"), "00te24bran73")
        self.assertEqual(
            Leetrovacki(base_mode="utro", min_word_length=5).encode("pas bazen"),
            "pas 00zen24ban73",
        )

    def test_nje_cyrillic_option(self) -> None:
        encoder = Leetrovacki(base_mode="utro", nje_style="њ")
    ...
    def test_tj_and_plain_c_options_propagate(self) -> None:
        ...
        self.assertEqual(Leetrovacki(base_mode="utro", plain_c_target="ч").encode("ацб"), "00чб24ан73")
